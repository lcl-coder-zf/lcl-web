...
export const metadata: Metadata = {
  ...
  description:
    "Consultoría en auditoría, gestión de riesgos y cumplimiento normativo en Colombia. BASC, ISO 9001, SG-SST, SAGRILAFT y SARLAFT. Medellín, Bogotá y acompañamiento virtual en todo el país.",
  keywords: [
    "auditoría BASC", "certificación ISO 9001", "SG-SST", "SAGRILAFT",
    "SARLAFT", "SIPLAFT", "cumplimiento normativo", "Medellín", "Colombia",
  ],
  openGraph: {
    type: "website",
    locale: "es_CO",
